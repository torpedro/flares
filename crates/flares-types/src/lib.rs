...
pub struct OpenIssue {
    #[cfg_attr(feature = "openapi", schema(min_length = 1, max_length = 200))]
    pub id: String,
    #[cfg_attr(feature = "openapi", schema(min_length = 1, max_length = 250))]
    pub title: Option<String>,
    #[cfg_attr(feature = "openapi", schema(min_length = 1, max_length = 1024))]
...
pub struct ListQuery {
    ...
    #[cfg_attr(feature = "openapi", param(minimum = 1, maximum = 1000, default = 100))]
    pub limit: u32,
    #[serde(default)]
    pub offset: u32,
}
