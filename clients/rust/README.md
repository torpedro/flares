...
Build independently with `cargo check -p flares-client --locked`. Client users need no server configuration files. The CLI adapts its existing YAML settings to this library.
